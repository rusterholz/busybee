...
module Busybee
  ...
  module Defaults
    ...
    DEFAULT_QUEUE_THROTTLE_MS = false
    DEFAULT_RUNNER_BACKPRESSURE_DELAY_MS = 5_000
    DEFAULT_RUNNER_MODE = :hybrid
    DEFAULT_RUNNER_SHUTDOWN_BACKOFF_MS = 10_000
    DEFAULT_STREAMING_QUEUE = true
  end
end
