...
RSpec.describe "GRPC Create Process Instance" do
  ...
  shared_context "with deployed process" do
  ...
  shared_examples "create process instance" do
    include_context "with deployed process"
  ...
  context "with local Zeebe", :integration do
    ...
    it_behaves_like "create process instance"
  end
